...
export const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-32 relative overflow-hidden">
      ...
      {hoveredCard !== null && (
        <motion.div
          className="fixed w-4 h-4 rounded-full bg-white/30 pointer-events-none blur-xl"
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-bold mb-8" style={{ fontFamily: "'Outfit', sans-serif" }}>
          ...
          >
            We're four friends — engineers, designers, and builders — crafting intelligent systems 
            that bridge technology and imagination.
          </motion.p>
        </motion.div>
          ...
          <div className="grid md:grid-cols-4 gap-6 relative z-10">
            {founders.map((founder, index) => (
              <motion.div
                ...
                className="glass-panel rounded-2xl p-6 text-center group cursor-pointer relative"
                style={{
              ...
              >
                ...
                <motion.div
                  className="absolute inset-0 rounded-2xl bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 smooth-transition"
