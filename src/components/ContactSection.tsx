...
export const ContactSection = () => {
  ...
  const contactMethods = [
    { icon: Mail, label: "Email", value: "hello@neuralabs.co", href: "mailto:hello@neuralabs.co", delay: 0.1 },
    { icon: Globe, label: "Website", value: "www.neuralabs.co", href: "https://neuralabs.lovable.app", delay: 0.2 },
    { icon: Phone, label: "Call", value: "+880 1823 604026", href: "tel:+8801823604026", delay: 0.3 },
  ];

  const socialLinks = [
    { icon: Linkedin, label: "LinkedIn", href: "#", delay: 0.4 },
    { icon: Instagram, label: "Instagram", href: "https://www.instagram.com/neuralabs.co/", delay: 0.5 },
    { icon: Globe, label: "Behance", href: "#", delay: 0.6 },
  ];
            ...
            <AnimatePresence mode="wait">
              {!isSubmitted ? (
                <motion.form
                  ...
                  className="glass-panel rounded-2xl p-8 space-y-8 relative overflow-hidden"
                >
                  {/* Form glow effect */}
                  <motion.div
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-background/40 border border-white/10 rounded-lg px-4 pt-6 pb-2 text-foreground focus:border-white/40 focus:ring-2 focus:ring-white/20 smooth-transition outline-none"
                      required
                    />
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      onBlur={() => setFocusedField(null)}
                      className="w-full bg-background/40 border border-white/10 rounded-lg px-4 pt-6 pb-2 text-foreground focus:border-white/40 focus:ring-2 focus:ring-white/20 smooth-transition outline-none min-h-[150px] resize-none"
                      required
                    />
                  </div>
          ...
          >
            ...
            <div className="glass-panel rounded-2xl p-8 space-y-6">
              ...
              {contactMethods.map((method, index) => (
                ...
                >
                  <motion.div
                    className="w-12 h-12 rounded-lg bg-white/5 flex items-center justify-center group-hover:bg-white/10 smooth-transition"
